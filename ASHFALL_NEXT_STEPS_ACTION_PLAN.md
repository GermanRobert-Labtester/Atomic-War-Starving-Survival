...
Following the comprehensive forensic audit across [`docs/ASHFALL_IMPLEMENTED_CANON_REGISTRY.md`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/docs/ASHFALL_IMPLEMENTED_CANON_REGISTRY.md) and [`docs/ASHFALL_EXPANSION_CONTEXT_ATLAS.md`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/docs/ASHFALL_EXPANSION_CONTEXT_ATLAS.md), this action plan identifies the **25 highest-impact next steps** to elevate ASHFALL from a functionally complete simulation core into a deeply integrated, polished, and content-rich post-nuclear survival management masterpiece.
...
* **Target Files:** [`Assets/Ashfall.Core/AirlockSecuritySystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/AirlockSecuritySystem.cs), [`Ashfall.Core.Tests/CoreInvariantSourceTests.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Ashfall.Core.Tests/CoreInvariantSourceTests.cs).
...
* **Target Files:** [`Assets/Ashfall.Core/World/LocationEvolutionSaveable.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core), [`Assets/Ashfall.Core/WildlifeSaveable.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core).
...
* **Target Files:** [`Assets/StreamingAssets/Data/**/*.json`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/StreamingAssets/Data), [`CatalogIntegrityValidator.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/CatalogIntegrityValidator.cs).
...
* **Problem / Gap:** [`VinylMoraleSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/VinylMoraleSystem.cs) is an isolated island providing an internal shelter morale buff, while [`FactionRadioEngine.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Radio/FactionRadioEngine.cs) only receives external audio signals.
...
* **Problem / Gap:** [`WildlifeTrappingSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/WildlifeTrappingSystem.cs) generates bushmeat and pelts in isolation without testing meat contamination against [`DiseaseSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Disease/DiseaseSystem.cs).
...
* **Problem / Gap:** [`SkyLayerArmorSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Shelter/SkyLayerArmorSystem.cs) models cell-grid roof armor against kinetic penetration, but is rarely tested outside of rare orbital strikes.
...
* **Problem / Gap:** [`CohortSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/CohortSystem.cs) and [`GenerationalLineageExtension.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/GenerationalLineageExtension.cs) track child maturation in the late game, but children cannot participate in daily bunker operations or education.
* **Action:** Wire adolescent dwellers into [`SkillProgressionSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Survivors/SkillProgressionSystem.cs) as apprentices. Assigning a youth to work alongside a Master Crafter in the Silent Foundry, Clinic, or Chem Lab accelerates skill XP gain by 200% and unlocks unique generational successor traits.
...
* **Problem / Gap:** [`WarlordDoctrineSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Warlords/WarlordDoctrineSystem.cs) schedules tribute collections on static day intervals regardless of active blizzard or fallout storms.
...
* **Problem / Gap:** Visiting merchant caravans evaluate item prices in [`TradeScreenSeam.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Economy/TradeScreenSeam.cs) without evaluating active shelter disease outbreaks.
...
* **Problem / Gap:** [`PharmaLabSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/PharmaLabSystem.cs) has a full 7-phase distillation state machine with purity and addiction rolls, but currently only supports a handful of basic medical recipes.
...
* **Problem / Gap:** [`WorkshopReverseEngineeringSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/WorkshopReverseEngineeringSystem.cs) implements artifact teardown, tool wear, and blueprint discovery, but has limited relic definitions in `relic_recipes.json`.
...
* **Problem / Gap:** [`ExpeditionVehicleSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/ExpeditionVehicleSystem.cs) models chassis stats, armor, fuel consumption, and breakdown rates, but standard playthroughs only spawn basic scout rigs.
...
* **Problem / Gap:** [`VinylMoraleSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/VinylMoraleSystem.cs) supports turntable audio playback and morale boosts, but has a sparse record catalog.
...
* **Problem / Gap:** [`ExcavationSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/ExcavationSystem.cs) models timber shoring, depth levels, and cave-in hazards, but is used primarily in starting room unlocks.
...
* **Problem / Gap:** [`ReckoningSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Verdict/ReckoningSystem.cs) and [`EvidenceLedger.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Verdict/EvidenceLedger.cs) evaluate evidence items to decide The Machine's Day 360 census verdict, but require more discoverable forensic dossiers.
...
* **Action:** Add a "Psychological Dossier" sub-tab to [`SurvivorsPanel.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/src/UI/SurvivorsPanel.cs) showing specific guilt crimes, active trauma triggers (e.g. panic on sirens), and trauma bond partnerships.
...
* **Problem / Gap:** [`PowerGridPanel.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/src/UI/PowerGridPanel.cs) shows numeric watt meters and load shedding buttons, but does not visualize circuit line stress or individual room short-circuits.
...
* **Problem / Gap:** Players tuning into shortwave signals in [`RadioPanel.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/src/UI/RadioPanel.cs) must manually decode audio Morse cues or check the journal codex.
...
* **Problem / Gap:** In [`CombatPanel.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/src/UI/CombatPanel.cs), complex ballistic physics (penetration vs armor thickness, ricochet chance, range falloff) operate under the hood without tactical previews.
...
* **Problem / Gap:** When a crucible explodes in [`SilentFoundrySystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Foundry/SilentFoundrySystem.cs), workers are injured, but it does not trigger an interactive emergency hospital trauma event in [`MedicalWardSystem.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/Ashfall.Core/Medical/MedicalWardSystem.cs).
...
* **Problem / Gap:** Early-game choices in [`door_encounters.json`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/Assets/StreamingAssets/Data/door_encounters.json) apply instant stat deltas but rarely trigger narrative callbacks months later.
...
* **Problem / Gap:** [`src/Main.cs`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/src/Main.cs) is a 7,014-line monolithic class containing 38 Setup, 30 Save, and 18 Flush methods across 24 domains.
