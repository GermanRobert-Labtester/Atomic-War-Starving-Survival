...
namespace AtomicWar.GodotApp.UI
{
    public partial class ArchaeologyExcavationPanel : Control, IBindablePanel
    {
        ...
        public void Bind(ArchaeologySystem system) { _system = system; RefreshView(); }
        public void Unbind() { _system = null; }

        public override void _Ready()
        {
            SetAnchorsPreset(LayoutPreset.FullRect);
            _shell = new AshfallDashboardShell("RECONSTRUCTION ARCHIVES // PRE-WAR EXCAVATION & LORE", minWidth: 1000, minHeight: 650);
            AddChild(_shell);
            _shell.SetContent(new Label { Text = "Archaeology module initializing..." });
