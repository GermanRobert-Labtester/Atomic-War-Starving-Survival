...
ARCHITECTURE_GRAPH = {
    ...
    "surgical_ward": {
        ...
        "routes": [],
        "cli": ["--save-store-checksum-selftest"],
        "tests": ["AdvancedSurgicalWardTests"]
    },
    "power_subgrids": {
        "domain": "Shelter & Infrastructure",
    ...
    "nuclear_core_lifecycle": {
        ...
        "routes": [],
        "cli": ["--save-store-checksum-selftest"],
        "tests": ["NuclearCoreLifecycleTests"]
    },
    "armored_crawlers": {
        "domain": "World & Expeditions",
        ...
        "routes": [],
        "cli": ["--save-store-checksum-selftest"],
        "tests": ["ArmoredCrawlerExpeditionTests"]
    },
    "personal_quests": {
    ...
    "vehicle_garage": { "domain": "Expeditions", "core": ["VehicleGarageSystem"], "catalog": ["vehicle_modifications.json"], "host": ["Main"], "setup": "SetupVehicleGarage", "ticked": False, "tick_type": "On-Demand", "store": ["VehicleGarageSaveStore"], "ui": [], "routes": [], "cli": [], "tests": ["VehicleGarageSystemTests"] },
