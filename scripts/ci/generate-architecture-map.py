...
ARCHITECTURE_GRAPH = {
    ...
    "consequence_ledger": { "domain": "Campaign", "core": ["CampaignConsequenceLedger", "CampaignConsequenceSaveState"], "catalog": [], "host": ["Main"], "setup": "SetupConsequenceLedger", "ticked": False, "tick_type": "None", "store": ["ConsequenceLedgerSaveStore"], "ui": [], "routes": [], "cli": ["--save-store-checksum-selftest"], "tests": ["CampaignConsequenceLedgerTests", "ConsequenceLedgerSaveTests"] },
    "recruitment": { "domain": "Survivors", "core": ["RecruitmentSystem", "RecruitmentState", "RecruitmentCensus"], "catalog": ["recruitment_templates.json"], "host": ["Main", "RecruitmentHostSession"], "setup": "SetupRecruitment", "ticked": True, "tick_type": "Daily Sim Tick", "store": ["RecruitmentSaveStore"], "ui": ["RecruitmentPanel"], "routes": ["recruitment"], "cli": ["--recruitment-selftest"], "tests": ["Plan204RecruitmentIntegrationTests"] },
}
