...
ARCHITECTURE_GRAPH = {
    ...
    "seasonal_celebration": { "domain": "Narrative", "core": ["SeasonalCelebrationSystem"], "catalog": ["shelter_celebrations.json"], "host": ["Main"], "setup": "SetupSeasonalCelebration", "ticked": True, "tick_type": "Daily Sim Tick", "store": ["SeasonalCelebrationSaveStore"], "ui": [], "routes": [], "cli": ["--orphan-seal-wave1-selftest"], "tests": ["Plan170SeasonalCelebrationsIntegrationTests"] },
    ...
    "outpost_settlement": { "domain": "Settlements", "core": ["OutpostSettlementSystem", "OutpostDef", "OutpostInstance", "OutpostSettlementState"], "catalog": ["outposts.json"], "host": ["OutpostSettlementHostSession", "Main"], "setup": "SetupOutpostSettlement", "ticked": True, "tick_type": "Daily Sim Tick", "store": ["OutpostSettlementSaveStore"], "ui": [], "routes": [], "cli": ["--outpost-settlement-selftest"], "tests": ["Plan58OutpostHostIntegrationTests", "Plan58OutpostSettlementIntegrationTests"] },
    ...
    "shelter_expansion": { "domain": "Shelter", "core": ["ShelterExpansionSystem"], "catalog": ["shelter_construction.json"], "host": ["Main"], "setup": "SetupShelterExpansion", "ticked": False, "tick_type": "Labor-Driven", "store": ["ShelterExpansionSaveStore"], "ui": [], "routes": [], "cli": ["--orphan-seal-wave1-selftest"], "tests": ["Plan156ShelterExpansionIntegrationTests"] },
    ...
    "ideological_friction": { "domain": "Survivors", "core": ["IdeologicalFrictionEvents", "IdeologicalFrictionSystem", "IdeologicalEventInstance", "IdeologicalFrictionCensus"], "catalog": ["ideological_events.json"], "host": ["Main", "IdeologicalFrictionHostSession"], "setup": "SetupIdeologicalFriction", "ticked": True, "tick_type": "Daily Sim Tick", "store": ["IdeologicalFrictionSaveStore"], "ui": ["SurvivorsPanel"], "routes": ["survivors"], "cli": ["--ideological-friction-selftest"], "tests": ["Plan148IdeologicalFrictionHostIntegrationTests", "Plan148IdeologicalFrictionIntegrationTests", "IdeologicalFrictionSystemTests"] },
    "romance_family": { "domain": "Survivors", "core": ["RomanceFamilySystem", "RomanticRelationship", "FamilyUnit", "RomanceCourtshipCatalog", "RomanceFamilyCensus", "RomanceCourtshipCatalogLoader"], "catalog": ["romance_courtship.json"], "host": ["Main", "RomanceFamilyHostSession"], "setup": "SetupRomanceFamily", "ticked": True, "tick_type": "Daily Sim Tick", "store": ["RomanceFamilySaveStore"], "ui": [], "routes": [], "cli": ["--romance-family-selftest"], "tests": ["Plan150RomanceFamilyHostIntegrationTests", "Plan150RomanceFamilyIntegrationTests", "RomanceCourtshipCatalogLoaderTests"] },
