...
ARCHITECTURE_GRAPH = {
    ...
    "visitor_integration": { "domain": "Visitors", "core": ["VisitorIntegrationSystem", "VisitorCatalogData"], "catalog": ["visitor_templates.json"], "host": ["Main", "VisitorIntegrationHostSession"], "setup": "SetupVisitorIntegration", "ticked": False, "tick_type": "None", "store": ["VisitorIntegrationSaveStore"], "ui": ["VisitorIntegrationPanel"], "routes": ["expanded"], "cli": ["--visitor-integration-selftest"], "tests": ["Plan214VisitorIntegrationTests"] },
