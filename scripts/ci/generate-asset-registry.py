...
def main():
    ...
    md_lines = [
        ...
        "",
        f"**Generated:** {manifest['generated_at']}<br>",
        f"**Total IDs Audited:** {total_ids}<br>",
        f"**Directly Loaded:** {total_loaded} ({manifest['summary']['coverage_pct']}%)<br>",
        f"**Fallbacks Used:** {total_fallback}<br>",
        "",
