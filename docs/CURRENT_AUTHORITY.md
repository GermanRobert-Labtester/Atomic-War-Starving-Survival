...
| **Save-Store Contract Matrix** | [`docs/saves/SAVE_STORE_CONTRACT_MATRIX.md`](file:///home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic%20War/docs/saves/SAVE_STORE_CONTRACT_MATRIX.md) | Generated completeness authority for all 62 save store classes, checksum envelopes, and slot-root isolation (`scripts/ci/generate-save-store-matrix.sh --check`). |
