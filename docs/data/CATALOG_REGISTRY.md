...
**Authoritative Location:** `Assets/StreamingAssets/Data/` | **Last Verified:** 2026-09-18
**Total Catalogs:** 620 | **Total Definitions:** 10386 | **Domain Families:** 32
...
### Core / Miscellaneous (161 Catalogs, 1287 Definitions)
...
| `duty_roles.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Items (14 Catalogs, 979 Definitions)
...
| `items.json` | 705 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `locations.json` | 169 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
