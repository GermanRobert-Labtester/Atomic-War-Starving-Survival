...
**Total Catalogs:** 621 | **Total Definitions:** 10400 | **Domain Families:** 32
...
### Radio & Signals (8 Catalogs, 234 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `radio.json` | 87 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radio_distress_signals.json` | 30 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
