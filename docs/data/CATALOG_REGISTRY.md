...
**Total Catalogs:** 705 | **Total Definitions:** 11023 | **Domain Families:** 32
...
### Audio & Music (4 Catalogs, 226 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `audio_accessibility_cues.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `audio_cues.json` | 196 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `combat_catalog.json` | 53 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `warlord_doctrines.json` | 72 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Core / Miscellaneous (225 Catalogs, 1832 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `accessibility_profiles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `achievements.json` | 16 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `acoustic_triangulation_catalog.json` | 11 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `aeroponics_nutrient_catalog.json` | 2 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `affliction_bridge_rules.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `aircraft_parts.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `alloys_and_ores.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `amphibious_draisine_catalog.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `anomalies.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `apprenticeship_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `aquaponics_system_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `archive_categories.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `archive_inks.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `armored_crawler_modules.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `art_forms.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `asset_registry.json` | 355 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `atmosphere_profiles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `atmospheric_sounding_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `autonomy_actions.json` | 20 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `backstory_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ballistic_shield_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ballistics_workbench_catalog.json` | 2 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `barter_rules.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `belief_movements.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `bio_fermentation_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `bionics.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `bounty_board.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `breaching_equipment_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `bunker_graffiti_postings.json` | 30 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `camouflage_gear.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `captive_interrogations.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `caravans.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `carbon_composite_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cargo_airdrop_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cascade_rules.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cellulosic_ethanol_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ceremonies.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `chemical_syntheses.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `chlor_alkali_synthesis_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `chronic_conditions.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `climbing_winch_catalog.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cohort_tuning.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `collectibles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `colony_blueprints.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `commitments.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `commodity_baselines.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `comms_targets.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `communication_templates.json` | 7 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `communications_networks.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `companion_animals.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `conflict_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cryo_cultivars.json` | 18 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cryogenic_air_separation.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cultural_archive_tomes.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `cvd_diamond_catalog.json` | 20 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `death_legacy_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `decontamination_protocol_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `defenses.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `development_traits.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `difficulty_presets.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `diplomatic_treaties.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `direction_finding_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `disaster_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `discovery_consequences.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `documentation_templates.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `dream_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `duty_roles.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ebpvd_coating_catalog.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `echoes.json` | 23 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ecological_infestations.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `education_curriculum.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `electrostatic_filtration_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `emergency_alerts.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `endings.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `espionage_missions.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `espionage_operations.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `exercise_routines.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `fallout_patterns.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `family_name_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `feedback_messages.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `field_guide.json` | 38 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `fischer_tropsch_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `fluid_infrastructure.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `fog_harvesting_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `food_preservation.json` | 9 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `food_types.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `geodetic_survey_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `geothermal_drilling_depths.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `geothermal_strata_catalog.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `gpr_exploration_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `grain_processing.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `heliograph.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `hidden_agendas.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `hobby_definitions.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `hydraulic_extrusion_catalog.json` | 9 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `infiltrator_profiles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `insar_geodesy_catalog.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `interrogation_tactics.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `kinetic_flywheel_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `labor_camps.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `leadership_policies.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ledger_debt_templates.json` | 25 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `legacy_traits.json` | 20 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `life_stages.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `lore_archives.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `low_background_lead_catalog.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `lyophilization_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `maritime_zones.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `memory_decay_rates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `mental_arcs.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `merchant_caravans.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `meta_unlockables.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `metrology_standards_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `microfluidic_diagnostic_catalog.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `mine_flail_catalog.json` | 2 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `mineral_acid_synthesis_catalog.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `mod_manifest_schema.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `museum_collection_templates.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `mutations.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `narcotics.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `narrative_discovery_manifest.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `narrative_encounters.json` | 16 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `narrative_encounters_expansion.json` | 29 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `narrative_encounters_npc_arcs.json` | 31 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `needs_performance.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `noise_sources.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `npc_arcs.json` | 65 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `npc_memory_dialogue.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `nuclear_core_profiles.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `nuclear_winter_phases.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `nutrition_profiles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `nvis_communications_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `outposts.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `pathogens.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `perimeter_defenses.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `personal_belongings.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `pneumatic_network_catalog.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `policies.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `political_policies.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `powder_metallurgy_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `precision_broaching_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `precision_optics_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `prewar_archives.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `propaganda_campaigns.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `propaganda_templates.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `psychological_therapies.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `psychological_trauma.json` | 14 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `psychology_profiles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radar_ecm_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `rail_grinding_catalog.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `rail_logistics_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `rationing_protocols.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `recon_telemetry_probes.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `recreation.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `recruitment_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `regional_prices.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `regional_treaties.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `relationship_bands.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `relationship_decay_profiles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `reputation_dimensions.json` | 13 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `rerailing_equipment_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `research_knowledge.json` | 62 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `research_unlocks.json` | 30 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `retention_policies.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `robotics.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `romance_courtship.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `routine_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `rumor_hubs.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `runflat_tire_catalog.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `sanitation_facilities.json` | 9 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `scavenging_tables.json` | 54 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `seismic_fault_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `settlements.json` | 12 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `skills.json` | 160 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `sky_defense_ordnance.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `sky_layer_armor_catalog.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `slice_seven_days.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `solar_concentrator_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `sound_ranging_catalog.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `spiritual_rituals.json` | 19 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `standing_gates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `starting_supplies.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `store_capability_claims.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `supply_lines.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `tech_salvage.json` | 4 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `thermal_gear.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `time_capsules.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `toxic_chemical_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `travel_encounters.json` | 57 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `treaty_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `trophies.json` | 11 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `underground_flora.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `underground_tunnels.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `utility_actions.json` | 20 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `uv_corona_detector_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `visitor_templates.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `wasteland_religions.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `wasteland_settlement_npcs.json` | 18 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `water_sources.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `waystations.json` | 14 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `wildlife_ecosystem.json` | 13 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Crafting & Relics (7 Catalogs, 165 Definitions)
...
| `metallurgy_recipes.json` | 12 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `recipes.json` | 123 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `recipes_cooking.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `crossing_encounters.json` | 37 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `duty_roster_seasons.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Economy & Trade (10 Catalogs, 78 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `black_market_inventory.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `caravan_trade_routes.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `economy_goods.json` | 50 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `hardcore_economy_tuning.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radiation_economy_social.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `trade_embargoes.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `trade_screen_scenarios.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `trade_texts.json` | 9 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Events (11 Catalogs, 407 Definitions)
...
| `events.json` | 240 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `ideological_events.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `incidents.json` | 25 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Expeditions & Vehicles (6 Catalogs, 88 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `anomalous_expedition_encounters.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `expeditions.json` | 75 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `vehicle_armor_grades.json` | 5 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `vehicle_modifications.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `vehicle_modules.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `vehicles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Factions (20 Catalogs, 317 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `crossing_factions.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_combat_thresholds.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_intelligence.json` | 12 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_lore.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_radio_corpus.json` | 35 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_territory.json` | 24 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_war_communiques.json` | 40 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_war_dialogue.json` | 40 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `independent_faction_branch.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `military_faction_branch.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `muster_faction_culture.json` | 25 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `rebel_faction_branch.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `standing_record_factions.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Foundry & Industry (4 Catalogs, 8 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `cupola_foundry_catalog.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `crop_strains.json` | 17 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `hydroponic_crops.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `holdfast_npcs.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Items (14 Catalogs, 998 Definitions)
...
| `crossing_items.json` | 25 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `dose_items.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `greenhouse_items.json` | 34 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `items.json` | 724 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Locations & Map (14 Catalogs, 455 Definitions)
...
| `deep_lore_locations.json` | 25 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `dose_locations.json` | 14 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `duty_roster_locations.json` | 14 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `faction_war_location_overrides.json` | 20 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `holdfast_locations.json` | 38 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `locations.json` | 179 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `locations_expansion3.json` | 21 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `map_regions.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `micro_locations.json` | 28 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `verdict_locations.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `wasteland_map_v1.json` | 22 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Medical & Health (6 Catalogs, 134 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `autopsy_procedures.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `disease_catalog.json` | 20 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `dose_registers.json` | 31 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `medical_record_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `moral_choice_flags.json` | 25 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `moral_choice_gossip.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Muster & Epilogue (7 Catalogs, 57 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `campaign_epilogues.json` | 9 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `currents.json` | 17 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `epilogue_chronicle.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `epilogue_personalization.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `muster_witnesses.json` | 27 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `narrative/bureaucratic_document_runtime_map.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Quests (27 Catalogs, 3297 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `crossing_quests.json` | 127 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `dose_quests.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `duty_roster_quests.json` | 160 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `dynamic_quest_templates.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `moral_choice_quests.json` | 68 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `moral_choice_quests_branching.json` | 100 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `moral_choice_quests_distress.json` | 12 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `moral_choice_quests_expansion.json` | 50 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `narrative_questlines.json` | 24 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `personal_quests.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `quest_templates.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `questline_master.json` | 511 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `quests_bureaucratic_morality.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `quests_expansion_05.json` | 148 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `quests_expansion_06.json` | 76 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `quests_npc_arcs.json` | 114 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `repeatable_quests.json` | 10 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `standing_record_quests.json` | 209 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Radio & Signals (8 Catalogs, 231 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `radio.json` | 87 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radio_distress_signals.json` | 27 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radio_distress_signals_expansion.json` | 13 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radio_intercepts.json` | 16 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radio_programs.json` | 2 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `radio_stations.json` | 6 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `verdict_radio.json` | 30 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `year_of_ash_radio.json` | 50 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Shelter & Power (16 Catalogs, 204 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `power_grid.json` | 18 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `power_subgrid_nodes.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_audio_cues.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_celebrations.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_components.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_construction.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_governance_blocs.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_insulation_catalog.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_machine_identities.json` | 38 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_origins.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_room_identities.json` | 87 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_rooms.json` | 35 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_schedules.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_security_zones.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `shelter_shielding.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `sofc_power_catalog.json` | 11 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Social & Psychology (3 Catalogs, 52 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `confession_secrets.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `final_wishes.json` | 52 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
### Survivors (11 Catalogs, 277 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `antigravity_survivor_fields.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `characters.json` | 84 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `starting_survivor_cohorts.json` | 17 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `starting_survivors.json` | 3 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `survivor_life_stages.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `survivor_roles.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `survivor_voice_lines.json` | 8 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `verdict_npcs.json` | 18 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Weather & Environment (5 Catalogs, 44 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `weather_effects.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `weather_gameplay_effects.json` | 15 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `weather_hardening_upgrades.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `weather_route_gates.json` | 18 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
| `weather_seasons.json` | 11 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |

### Whitelists & Infrastructure (3 Catalogs, 0 Definitions)

| Catalog Path | Definitions | Schema | Classification | Primary C# Loader |
|---|---|---|---|---|
| `whitelists/companion_trust_flags.json` | 0 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
...
| `year_of_ash_storm_windows.json` | 14 | `1.0.0` | `GAMEPLAY_CONSUMED` | `Core default` |
