...
| 23 | `ExpeditionSaveStore` | [`src/Host/ExpeditionSaveStore.cs`](file:////home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic War/src/Host/ExpeditionSaveStore.cs) | `expedition` | `expedition_save.json` | `TryLoad()` | ✅ | ✅ | `BareSaveStoreSealTests.cs`, `CrossingQuestSystemTests.cs` *(+1 more)* |
...
| 29 | `JournalSaveStore` | [`src/Journal/JournalSaveStore.cs`](file:////home/robertsrff/Music/Atomic_War_Straving_Survival/Atomic War/src/Journal/JournalSaveStore.cs) | `journal` | `journal_save.json` | `Load()`, `Save()` | ✅ | ✅ | — |
