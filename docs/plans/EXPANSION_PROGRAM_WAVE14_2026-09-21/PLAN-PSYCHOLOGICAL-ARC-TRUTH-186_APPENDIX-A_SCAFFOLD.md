# PLAN-PSYCHOLOGICAL-ARC-TRUTH-186 — Appendix A: Implementation Scaffold
...
- Proposed method names: `SetupSurvivorsPATScaffold` / `SaveSurvivorsPATScaffold` (Plan 1 Appendix AI: collision-free)
- Loop/day coupling: consult Plan 1 Appendix AA before adding any step method.

## 5. Test scaffold (proposed, not created)

Proposed file: `Ashfall.Core.Tests/Survivors/PAT186ScaffoldTests.cs`

```csharp
// One fixture per package, plus one authority-conformance fixture.
public class PAT186ScaffoldTests
{
    [Fact] public void PAT186A_TODO() { /* stage model + transition table. */ }
    [Fact] public void PAT186B_TODO() { /* move rules + cycle bound tests. */ }
    [Fact] public void PAT186C_TODO() { /* guardrail fixtures (no unexitable stage; terminal/reversible declared). */ }
    [Fact] public void PAT186D_TODO() { /* treatment-input contract with Plan 144. */ }
    [Fact] public void PAT186E_TODO() { /* save round-trip; no re-roll on load. */ }
    [Fact] public void PAT186_AuthorityConformance_TODO() { /* pattern parity with PLAN-MENTAL-HEALTH-THERAPY-64 */ }
}}
```
