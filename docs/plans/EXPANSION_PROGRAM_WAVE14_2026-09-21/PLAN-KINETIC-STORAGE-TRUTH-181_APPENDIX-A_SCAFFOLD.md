# PLAN-KINETIC-STORAGE-TRUTH-181 — Appendix A: Implementation Scaffold

**Generated:** 2026-09-21 by the session scaffold generator (paired variant, batch 3).
**Scaffolding authority:** [`PLAN-ENERGY-NUCLEAR-48`](../EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-ENERGY-NUCLEAR-48.md) — adopt the authority's patterns rather than inventing a second architecture. **Convention authority:** `PLAN-ORPHAN-SEAL-01` (generated, reproducible appendices).
...
## 2. Source inventory (86 files, Core + host)
...
- Proposed method names: `SetupShelterKSScaffold` / `SaveShelterKSScaffold` (Plan 1 Appendix AI: collision-free)
- Loop/day coupling: consult Plan 1 Appendix AA before adding any step method.

## 5. Test scaffold (proposed, not created)

Proposed file: `Ashfall.Core.Tests/Shelter/KS181ScaffoldTests.cs`

```csharp
// One fixture per package, plus one authority-conformance fixture.
public class KS181ScaffoldTests
{
    [Fact] public void KST181A_TODO() { /* storage model + loss table. */ }
    [Fact] public void KST181B_TODO() { /* charge/discharge bound tests (no over/underflow). */ }
    [Fact] public void KST181C_TODO() { /* grid balance integration test with Plan 48. */ }
    [Fact] public void KST181D_TODO() { /* failure mode + containment requirement fixture. */ }
    [Fact] public void KST181E_TODO() { /* save round-trip; loss continues from the stored hour. */ }
    [Fact] public void KS181_AuthorityConformance_TODO() { /* pattern parity with PLAN-ENERGY-NUCLEAR-48 */ }
}}
```
