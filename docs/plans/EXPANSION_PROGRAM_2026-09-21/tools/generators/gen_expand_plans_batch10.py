...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE16_2026-09-21/PLAN-WEATHER-INTELLIGENCE-TRUTH-218.md',['World'],['weatherintel','hardening'],'World',['WeatherIntelligenceCoordinator.cs','WeatherHardeningSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-TELEMETRY-PRIVACY-58.md',['Telemetry'],['telemetry','recorder','metric'],'Telemetry',['PlaySessionRecorder.cs','PlayableMetricsAggregationEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-PRINT-MEDIA-TRUTH-128.md',['Print'],['broadsheet','print'],'Print',['PublicBroadsheetPressEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-NARRATIVE-ARC-EVENT-TRUTH-176.md',['Narrative'],['narrativearc'],'Narrative',['NarrativeArcEventSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-SETTINGS-INTEGRITY-54.md',['Settings','Audio'],['settings','codec'],'Settings',['AudioSettingsCodec.cs','AudioSettingsData.cs','UserSettingsData.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-HEALTH-HISTORY-TRUTH-196.md',['Medical'],['healthhistory'],'Medical',['HealthHistorySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-ONBOARDING-TRUTH-55.md',['Onboarding'],['onboarding','tutorial','hint'],'Onboarding',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-ECHO-TRUTH-201.md',['Narrative'],['echo'],'Narrative',['EchoSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-TUNNEL-NETWORK-TRUTH-194.md',['Underground'],['tunnel'],'Underground',['TunnelNetworkSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-BACKSTORY-REVEAL-TRUTH-126.md',['Survivors'],['backstory'],'Survivors',['BackstorySystem.cs']),
]
