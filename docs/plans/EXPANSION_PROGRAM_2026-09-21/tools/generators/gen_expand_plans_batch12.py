...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-RUMOR-PROPAGATION-TRUTH-120.md',['Economy','InformationFlow'],['rumor'],'Economy',['EconomyMarketRumorRules.cs','RumorSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-TRADE-EMBARGO-TRUTH-166.md',['Economy'],['embargo'],'Economy',['TradeEmbargoSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-PLATFORM-PARITY-53.md',['Settings','UI'],['platform','settings','input'],'Settings',['UserSettingsData.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-MORTUARY-MEMORIAL-TRUTH-123.md',['Culture'],['memorial','rite'],'Culture',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-ARCHAEOLOGY-TRUTH-152.md',['Archaeology'],['archaeo'],'Archaeology',['ArchaeologySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-CRAFT-QUALITY-TRUTH-112.md',['Crafting'],['craft','recipe'],'Crafting',['CraftingSystem.cs','RecipeCatalogLoader.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-CHLOR-ALKALI-TRUTH-199.md',['Shelter'],['chlor'],'Shelter',['ChlorAlkaliSynthesisEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-BLACK-PROJECTS-TRUTH-205.md',['Narrative'],['blackproject'],'Narrative',['BlackProjectsArchiveSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-FACTION-BRANCH-TRUTH-171.md',['Factions'],['branch'],'Factions',['FactionBranchCoordinator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-SCENARIO-AUTHORING-102.md',['Campaign'],['scenario','slice'],'Campaign',['SliceScenario.cs']),
]
