...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-MUTATION-HEREDITY-81.md',['Medical','Survivors'],['mutat','gene','heredit','congenital'],'Medical',['MutationSystem.cs','AntenatalMaternalHealthEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-ASYLUM-REFUGEES-85.md',['Visitors'],['visitor','refugee','asylum'],'Visitors',['VisitorIntegrationSystem.cs','RecruitmentSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-BIONICS-ENHANCEMENT-78.md',['Medical'],['prosthe','bionic','graft','implant','rehab'],'Medical',['ProstheticConditionWearEngine.cs','RehabilitationProgressionEngine.cs','SurgicalGraftRejectionEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-CRISIS-DISASTER-RESPONSE-80.md',['Emergency','Shelter'],['disaster','emergency','muster'],'Emergency',['DisasterResponseSystem.cs','EmergencyAlertSystem.cs','EmergencyMusterReadinessEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-BASE-DEFENSE-RAIDS-61.md',['Defense','World'],['defense','raid','patrol'],'Defense',['PerimeterEarlyWarningEngine.cs','NightWatchPatrolReadinessEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-ANCIENT-RUINS-VAULTS-84.md',['Archaeology','Narrative'],['ruin','vault','relic','ancient'],'Archaeology',['ArchaeologySystem.cs','BlackProjectsArchiveSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-SAVE-MIGRATION-CORRIDOR-87.md',['Save'],['migration','envelope','schema'],'Save',['SaveSectionRegistry.cs','SchemaVersionedEnvelope.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-DEEP-STRATA-83.md',['Subterranean','Excavation','Shelter'],['subterran','strata','excavat','geotherm'],'Shelter',['SubterraneanSystem.cs','SubterraneanZoneCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-COMBAT-DEPTH-62.md',['Combat'],['combat','weapon','ballistic','breach','tactical'],'Combat',['TacticalCombatSystem.cs','BallisticsWorkbenchSystem.cs','WeaponConditionSystem.cs']),
]
