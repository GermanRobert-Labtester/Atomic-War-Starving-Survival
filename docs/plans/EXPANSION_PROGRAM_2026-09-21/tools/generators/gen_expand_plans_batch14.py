...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-RADIATION-BACKGROUND-TRUTH-189.md',['Radiation'],['radiat','lead','shielding'],'Radiation',['LowBackgroundLeadEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-RAIL-MAINTENANCE-TRUTH-158.md',['Rail'],['rail'],'Rail',['RailTrackMaintenanceEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-JOURNEY-CONTEXT-TRUTH-156.md',['Journeys'],['journey'],'Journeys',['JourneyExecutionContext.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-INPUT-REBINDING-106.md',['Settings'],['input','settings'],'Settings',['UserSettingsData.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-SHELTER-CAPACITY-AUTHORITY-103.md',['Shelter','Needs'],['capacity','occupancy','sleep','acoustic'],'Shelter',['SleepAcousticRestEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-DOCUMENT-DISCOVERY-TRUTH-192.md',['Narrative'],['bureaucratic','document'],'Narrative',['BureaucraticDocumentDiscoverySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-GENERATIONAL-MILESTONE-TRUTH-160.md',['Generations'],['generation'],'Generations',['SecondGenerationMilestoneEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-RATIONING-TRUTH-174.md',['Economy'],['ration'],'Economy',['ResourceRationingSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-AQUIFER-MONITORING-TRUTH-164.md',['Shelter'],['aquifer','piezometer'],'Shelter',['AquiferPiezometerEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-CONTENT-PIPELINE-QA-77.md',['Content'],['content','validat','gate'],'Content',[]),
]
