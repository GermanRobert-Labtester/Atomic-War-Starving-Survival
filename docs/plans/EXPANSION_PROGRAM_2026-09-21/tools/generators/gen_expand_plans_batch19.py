...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-ESPIONAGE-SYSTEM-TRUTH-161.md',['Factions','Espionage'],['espionage','informant','covert'],'Factions',['EspionageSystem.cs','InformantNetworkTradecraftEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-HOST-EVENT-ARCHIVE-91.md',['Telemetry','Journal'],['telemetry','recorder','journal'],'Telemetry',['PlaySessionRecorder.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-ACUTE-TRAUMA-CARE-124.md',['Medical'],['trauma','triage','surgical','rehab'],'Medical',['ClinicalWardTriageEngine.cs','SurgicalGraftRejectionEngine.cs','RehabilitationProgressionEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-PLAYER-COMMAND-TRUTH-131.md',['PlayerCommand'],['command'],'PlayerCommand',['PlayerCommandCode.cs','CommandResult.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-SKY-DEFENSE-TRUTH-135.md',['SkyDefense'],['skydefense','ordnance'],'SkyDefense',['SkyDefenseBatterySystem.cs','SkyDefenseOrdnanceCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-DUTY-ROSTER-TRUTH-101.md',['DutyRoster'],['duty','morale'],'DutyRoster',['DutyRosterSystem.cs','DutyHourLedger.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-BOOTSTRAP-GATE-TRUTH-147.md',['Orchestration'],['manifest','bootstrap','gate'],'Orchestration',['SubsystemManifest.cs','BootstrapLifecycleGate.cs','LedgerTruthIntegrityGate.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-MUSTER-COALITION-TRUTH-130.md',['Muster'],['muster','coalition','camp','epilogue'],'Muster',['CoalitionCampSystem.cs','EpilogueMatrix.cs','FactionActionBoard.cs']),
]
