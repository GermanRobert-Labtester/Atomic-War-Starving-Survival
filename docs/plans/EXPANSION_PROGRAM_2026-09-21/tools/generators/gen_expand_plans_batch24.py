...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-TEMPORAL-AUTHORITY-33.md',['Campaign'],['clock','daycoord','temporal','calendar'],'Campaign',['CampaignDayCoordinator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-RADIO-MEDIA-42.md',['Radio'],['radio','broadcast','media'],'Radio',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-ESPIONAGE-COUNTERINTEL-41.md',['Espionage','Factions'],['espionage','informant','covert'],'Espionage',['InformantNetworkTradecraftEngine.cs','FactionCovertOpsCoordinator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-LIFECYCLE-SEALING-32.md',['Orchestration'],['lifecycle','manifest','gate'],'Orchestration',['SubsystemManifest.cs','BootstrapLifecycleGate.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-RECREATION-MORALE-50.md',['Survivors','DutyRoster'],['hobby','downtime','morale'],'Survivors',['HobbySystem.cs','MoraleMarkSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-REFERENCE-INTEGRITY-34.md',['IO'],['integr','validator','reference'],'IO',['CatalogIntegrityCheckers.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-MARITIME-DEEPWATER-27.md',['Maritime'],['maritime','dive','naval'],'Maritime',['MaritimeExplorationSystem.cs']),
]
