...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-NOMADS-CARAVAN-CULTURE-82.md',['Economy','Visitors','Settlements'],['nomad','caravan','migration','visitor'],'Economy',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-TEXT-PACK-LOCALIZATION-88.md',['Localization'],['l10n','localis','localiz','textpack'],'Localization',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-SAVE-INTEGRITY-FUZZ-OPERATIONS-98.md',['Save'],['envelope','checksum','fuzz','corrupt'],'Save',['SaveEnvelopeHelper.cs','SaveStore.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-LABOUR-PROFESSIONS-68.md',['DutyRoster','Survivors'],['profession','labour','role'],'DutyRoster',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-AUDIO-MIX-AUTHORITY-97.md',['Audio'],['audio','cue','ambience','acoustic'],'Audio',['ShelterAudioCueCatalog.cs','ShelterAcousticDirector.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-CARTOGRAPHY-LANDMARKS-70.md',['World','Exploration'],['cartograph','landmark','fieldguide'],'World',['FieldGuideCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-AUTONOMOUS-MACHINES-79.md',['Crafting','Foundry','AdvancedMachinery'],['robot','machine','autom','drone'],'Crafting',['AdvancedMachineContracts.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-ECONOMY-LEDGER-TRUTH-96.md',['Economy'],['ledger','market','funds','credit'],'Economy',['FundsLedger.cs','MarketSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-SPATIAL-SIM-AUTHORITY-95.md',['World'],['route','territor','settlement','mapregion'],'World',['RouteRegionTopology.cs','PatrolTerritoryAuthority.cs']),
]
