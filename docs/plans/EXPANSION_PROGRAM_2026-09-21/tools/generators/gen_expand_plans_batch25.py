...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-FAMILY-DYNASTY-43.md',['Survivors','Generations'],['relationship','genealogy','secondgeneration'],'Survivors',['RelationshipDecaySystem.cs','SecondGenerationMilestoneEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-BELIEF-IDEOLOGY-36.md',['Spiritual','Culture'],['belief','spirit','ritual'],'Spiritual',['SpiritualRitualCalendarEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-JUSTICE-LAW-37.md',['Verdict','Narrative'],['verdict','justice'],'Verdict',['VerdictAccusationSystem.cs','JusticeSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-ENERGY-NUCLEAR-48.md',['Shelter'],['power','energy','nuclear','reactor','kinetic'],'Shelter',['PowerLoadSheddingEngine.cs','KineticStorageSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-CRIME-SYNDICATES-44.md',['Economy','Factions'],['blackmarket','contraband','loan','crime'],'Economy',['BlackMarketSystem.cs','BlackMarketContrabandEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-PANDEMIC-PUBLIC-HEALTH-47.md',['Disease','Medical'],['disease','quarantine','pathogen','outbreak'],'Disease',['DiseaseQuarantineCoordinator.cs','PathogenStrainSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-SIGNALS-REMOTE-SENSING-49.md',['World','Radio'],['radar','insar','signal','sonde'],'World',['GroundPenetratingRadarEngine.cs','InSarDeformationEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-WATER-AGRICULTURE-46.md',['Water','Farming'],['water','aquifer','soil','oilseed'],'Water',['WaterQualityProfileEngine.cs','WaterSourceSystem.cs','SoilReclamationProfileEngine.cs']),
]
