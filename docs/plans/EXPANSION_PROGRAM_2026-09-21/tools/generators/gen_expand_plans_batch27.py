...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE2_2026-09-21/PLAN-RUNTIME-PERF-16.md',['Performance'],['perf'],'Performance',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE2_2026-09-21/PLAN-NARRATIVE-GRAPH-18.md',['Narrative'],['narrative','quest','flag'],'Narrative',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE2_2026-09-21/PLAN-UI-SURFACE-15.md',['UI'],['panel','surface'],'UI',[]),
]
