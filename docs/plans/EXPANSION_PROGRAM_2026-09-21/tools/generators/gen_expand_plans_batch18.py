...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-NARRATIVE-CONSEQUENCE-TRUTH-132.md',['NarrativeConsequence'],['consequence'],'NarrativeConsequence',['NarrativeConsequenceGraph.cs','NarrativeSimulator.cs','NarrativeValidator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-ACHIEVEMENTS-COMPLETION-TRUTH-76.md',['Achievements'],['achiev'],'Achievements',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE7_2026-09-21/PLAN-DEV-TOOLING-TRUTH-75.md',['Performance'],['console','overlay','inspector','demo'],'Performance',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-CODEX-SURFACE-TRUTH-110.md',['UI','Narrative'],['codex','fieldguide','presentation'],'UI',['FieldGuideCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-CONTRACT-BOARD-109.md',['Economy'],['contract','board','market'],'Economy',[]),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-HEIRLOOM-PHANTOM-TRUTH-149.md',['Phantoms'],['heirloom','phantom'],'Phantoms',['HeirloomSystem.cs','HeirloomCatalog.cs','PhantomTriggerDto.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-LEADERSHIP-TRUTH-173.md',['Survivors'],['leadership'],'Survivors',['LeadershipSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-NARRATIVE-CONTINUITY-TRUTH-170.md',['Narrative'],['continuity'],'Narrative',['NarrativeContinuityEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-STANDING-RECORD-TRUTH-139.md',['StandingRecord'],['standing','location'],'StandingRecord',['StandingRecordEngine.cs','LocationMemorySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-AQUAPONICS-TRUTH-163.md',['Shelter'],['aquapon','hydropon','aeropon'],'Shelter',['AquaponicsSystem.cs','HydroponicBiomeSystem.cs','AeroponicsSystem.cs']),
]
