...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE16_2026-09-21/PLAN-CRYO-VAULT-TRUTH-206.md',['Shelter'],['cryo','vault'],'Shelter',['CryoVaultSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE18_2026-09-21/PLAN-CASCADE-COORDINATOR-TRUTH-249.md',['Shelter'],['cascade'],'Shelter',['CascadeCoordinator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE16_2026-09-21/PLAN-SOCIAL-DYNAMICS-TRUTH-214.md',['Shelter'],['social'],'Shelter',['ShelterSocialDynamicsSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE18_2026-09-21/PLAN-SURVIVOR-ROSTER-TRUTH-244.md',['Survivors'],['roster'],'Survivors',['SurvivorCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE17_2026-09-21/PLAN-CARBON-COMPOSITE-TRUTH-240.md',['Shelter'],['carbon','composite'],'Shelter',['CarbonCompositeEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-CROSSING-QUEST-TRUTH-190.md',['Crossing'],['crossing'],'Crossing',['CrossingQuestSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE17_2026-09-21/PLAN-FACTION-BRANCH-STATUS-TRUTH-228.md',['Factions'],['branch'],'Factions',['MilitaryBranchSystem.cs','RebelBranchSystem.cs','IndependentBranchSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-BALLISTICS-WORKBENCH-TRUTH-184.md',['Combat'],['ballistic','workbench'],'Combat',['BallisticsWorkbenchSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-PLASTIC-PYROLYSIS-TRUTH-187.md',['Shelter'],['pyrolysis','plastic'],'Shelter',['PlasticPyrolysisSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE17_2026-09-21/PLAN-CEREMONY-SYSTEM-TRUTH-223.md',['Narrative'],['ceremony','festival'],'Narrative',['CeremonySystem.cs']),
]
