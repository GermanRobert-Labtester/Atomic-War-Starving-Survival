...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE16_2026-09-21/PLAN-CRAFT-ARCHIVE-TRUTH-208.md',['Narrative'],['technicalmaterial','leatherwork'],'Narrative',['TechnicalMaterialArchiveSystem.cs','LeatherworkArchiveSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-GEOTHERMAL-PLANT-TRUTH-191.md',['Shelter'],['geothermal'],'Shelter',['GeothermalOrcSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-PNEUMATIC-DISPATCH-TRUTH-180.md',['Shelter'],['pneumatic'],'Shelter',['PneumaticDispatchSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-SAVE-PREVIEW-METADATA-114.md',['Save'],['slot','envelope','preview'],'Save',['SaveSlotService.cs','SaveSlotTypes.cs','CampaignEnvelopeBuilder.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-THERMAL-EXPOSURE-TRUTH-117.md',['Inventory','Textiles'],['warmth','thermal'],'Inventory',['ClothingWarmthSystem.cs','GarmentLayeringThermalEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-CAREGIVING-TRUTH-203.md',['Survivors'],['caregiv'],'Survivors',['CaregivingSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-SEISMIC-DYNAMICS-TRUTH-193.md',['Shelter'],['seismic'],'Shelter',['SeismicDynamicsSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE14_2026-09-21/PLAN-KINETIC-STORAGE-TRUTH-181.md',['Shelter'],['kinetic'],'Shelter',['KineticStorageSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-NPC-ARCS-TRUTH-143.md',['NpcArcs'],['npcarc'],'NpcArcs',['NpcArcCatalog.cs','NpcArcSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-COMMITMENTS-OBLIGATIONS-TRUTH-122.md',['Commitments','Narrative'],['commitment','letter'],'Commitments',['CommitmentSystem.cs','LetterDeliverySystem.cs','SurvivorLetterDeliverySystem.cs']),
]
