...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-MAINTENANCE-DECAY-TRUTH-119.md',['Shelter','Inventory'],['maintenance','condition','wear'],'Shelter',['ShelterMaintenanceSystem.cs','EquipmentConditionSystem.cs','ProstheticConditionWearEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-NOISE-DISCIPLINE-TRUTH-116.md',['Shelter','Defense'],['noise'],'Shelter',['ShelterNoiseSystem.cs','NoiseDisciplineSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-INTERNAL-COMMUNICATION-TRUTH-159.md',['Communication'],['communication','timecapsule'],'Communication',['InternalCommunicationSystem.cs','TimeCapsuleSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-CREATIVE-WORKS-66.md',['Culture'],['culture','festival','museum','creative'],'Culture',['CultureCreationSystem.cs','ShelterFestivalEngine.cs','ShelterMuseumSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-MORAL-CHOICE-TRUTH-136.md',['MoralChoice'],['moralchoice'],'MoralChoice',['MoralChoiceSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-MENTAL-HEALTH-THERAPY-64.md',['Psychology','Sanatorium'],['psych','therapy','sanator'],'Psychology',['PsychologicalProfileSystem.cs','PsychologicalSanatoriumSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-ANOMALY-PHANTOM-63.md',['Phantoms','World'],['phantom','anomaly','confession'],'Phantoms',['ConfessionSecretSystem.cs','AnomalyHazardSystem.cs']),
]
