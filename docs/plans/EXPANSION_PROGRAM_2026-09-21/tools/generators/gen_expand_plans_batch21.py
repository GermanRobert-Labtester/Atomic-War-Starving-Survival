...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-ENDGAME-EVALUATION-TRUTH-137.md',['Endgame'],['endgame','epilogue','ending','outcome'],'Endgame',['UnifiedEndingResolver.cs','EpilogueMatrixRuntime.cs','CampaignOutcomeEvaluator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-COLLECTIBLES-RELICS-67.md',['Collectibles'],['collectible','relic','trophy'],'Collectibles',['RelicCatalogLoader.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-SHELTER-POLITICS-69.md',['Governance'],['governance','policy','politics'],'Governance',['PolicySystem.cs','ShelterGovernanceEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-MOD-CONTENT-BOUNDARY-92.md',['Mods'],['mod'],'Mods',['JsonModLayering.cs','ModCompatibilityEvaluator.cs','ModDataContract.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-DETERMINISM-CROSS-HOST-89.md',['Random','Save'],['rng','checksum','determin'],'Save',['CampaignRngStream.cs','SaveChecksum.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-ADVANCED-MACHINERY-CONTRACTS-TRUTH-140.md',['AdvancedMachinery'],['machinecontract'],'AdvancedMachinery',['AdvancedMachineContracts.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-DATA-SCHEMA-COVERAGE-90.md',['IO'],['schema','normaliz','loadresult'],'IO',['CatalogBootValidator.cs','CatalogKeyNormalizer.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-YEAR-OF-ASH-TRUTH-146.md',['YearOfAsh'],['yearofash','timeline','storm','ice','radon','factionwar'],'YearOfAsh',['YearOfAshTimelineSystem.cs','YearOfAshSave.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE8_2026-09-21/PLAN-INVENTORY-CONSERVATION-93.md',['Inventory'],['inventory','transaction','migrat'],'Inventory',['InventoryTransaction.cs','InventoryMigrator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-ELECTRONICS-COMPUTING-65.md',['Crafting','Shelter'],['electronic','circuit','comput'],'Crafting',[]),
]
