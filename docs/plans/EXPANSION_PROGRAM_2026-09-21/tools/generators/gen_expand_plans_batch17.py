...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-SANATORIUM-TRUTH-144.md',['Sanatorium'],['sanator'],'Sanatorium',['PsychologicalSanatoriumSystem.cs','PsychologicalTherapyCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE12_2026-09-21/PLAN-CATALOG-BOOT-TRUTH-148.md',['IO'],['catalogboot','normalizer','loadresult','diagnostic'],'IO',['CatalogBootValidator.cs','CatalogKeyNormalizer.cs','CatalogLoadResult.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-SAVE-SLOT-UX-105.md',['Save'],['slot','store'],'Save',['SaveSlotService.cs','SaveSlotTypes.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-WEATHER-SONDE-TRUTH-168.md',['World'],['sonde','weatherintel'],'World',['WeatherSondeSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-RUNTIME-RESILIENCE-57.md',['Save','Orchestration'],['resilien','durability','gate'],'Save',['BootstrapLifecycleGate.cs','SessionDurabilityManager.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE6_2026-09-21/PLAN-ACCESSIBILITY-CLOSURE-51.md',['Accessibility','UI'],['accessib','focus'],'Accessibility',['AccessibilitySettingsSystem.cs','AudioAccessibilityCoordinator.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-MORALE-CONTAGION-TRUTH-162.md',['Survivors'],['contagion'],'Survivors',['MoraleContagionSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-FEEDBACK-SURFACE-TRUTH-138.md',['Feedback'],['feedback'],'Feedback',['FeedbackService.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-STARTING-LEVEL-TRUTH-145.md',['StartingLevel'],['starting'],'StartingLevel',['StartingLevelSystem.cs','StartingLevelState.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-INSTITUTIONS-TRUTH-141.md',['Institutions'],['institution'],'Institutions',['InstitutionAssignmentLedger.cs','IInstitutionAvailability.cs']),
]
