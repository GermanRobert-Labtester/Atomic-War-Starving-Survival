...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-DISCOVERY-STATE-108.md',['World'],['damagedmap','fieldguide','knowledge'],'World',['DamagedMapSystem.cs','FieldGuideCatalog.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE13_2026-09-21/PLAN-PERIMETER-DEFENSE-TRUTH-165.md',['Defense'],['perimeter'],'Defense',['PerimeterDefenseSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-SKILL-PROGRESSION-TRUTH-113.md',['Survivors'],['skill'],'Survivors',['SkillProgressionSystem.cs','SkillAtrophySystem.cs','SkillCatalogLoader.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-MEMORY-DECAY-TRUTH-142.md',['Cognition'],['memory'],'Cognition',['MemoryDecaySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-UTILITY-AI-TRUTH-133.md',['UtilityAI'],['utility'],'UtilityAI',['UtilityAiSystem.cs','UtilityActionScorer.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE15_2026-09-21/PLAN-RELATIONSHIP-DECAY-TRUTH-195.md',['Survivors'],['relationship'],'Survivors',['RelationshipDecaySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE11_2026-09-21/PLAN-THIRDONARY-COVENANT-TRUTH-134.md',['Thirdonary'],['thirdonary'],'Thirdonary',['ThirdonaryQuestSystem.cs','ThirdonarySave.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE10_2026-09-21/PLAN-PRESERVATION-TRUTH-118.md',['Shelter','Farming','Medical'],['preserv','lyophil','oilseed','cryo'],'Shelter',['OilseedPressingEngine.cs','LyophilizationSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE9_2026-09-21/PLAN-CAMPAIGN-PORTABILITY-104.md',['Save'],['envelope','campaign','export'],'Save',['SaveEnvelopeHelper.cs','CampaignEnvelopeBuilder.cs']),
]
