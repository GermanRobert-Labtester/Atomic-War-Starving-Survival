...
def klass(fn):
    ...
    return 'Support'
T=[
 ('docs/plans/EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-INDUSTRY-AUTOMATION-45.md',['Shelter'],['foundry','kiln','cupola','synthesis','pyrolysis','coating'],'Shelter',['CupolaFoundryEngine.cs','KilnFiringEngine.cs','ChemicalReagentSynthesisEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-SCIENCE-EDUCATION-38.md',['Education'],['education','apprentice','curriculum'],'Education',['SurvivorEducationSystem.cs','ApprenticeshipCurriculumEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-FOOD-CUISINE-39.md',['Kitchen','Nutrition','Cooking','Farming'],['food','cook','ration','kitchen'],'Cooking',['FoodTypeSystem.cs','CookingSystem.cs','CommonTableRationingEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE3_2026-09-21/PLAN-WARLORDS-DIPLOMACY-29.md',['Factions','Diplomacy','Muster'],['faction','diplomacy','territory','standing'],'Factions',['FactionDiplomacySystem.cs','TerritoryControlSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE3_2026-09-21/PLAN-TRANSPORT-EXPEDITION-30.md',['Expeditions','Vehicles','Rail','Waystation'],['expedition','vehicle','rail','waystation','travel'],'Expeditions',['ModalTravelDispatchEngine.cs','VehicleCustomizationSystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE3_2026-09-21/PLAN-WEATHER-ATMOSPHERE-28.md',['Weather','World'],['weather','storm','cascade','winter','forecast'],'Weather',['WeatherCascadeSystem.cs','NuclearWinterProgressionSystem.cs','WeatherForecastReliabilityEngine.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE3_2026-09-21/PLAN-ECOLOGY-WILDLIFE-26.md',['Bestiary','World'],['wildlife','bestiary','quota'],'Bestiary',['WildlifeHarvestQuotaEngine.cs','BestiarySystem.cs']),
 ('docs/plans/EXPANSION_PROGRAM_WAVE4_2026-09-21/PLAN-SHELTER-ARCHITECTURE-40.md',['Shelter','Excavation'],['expansion','subsidence','subterran'],'Shelter',['ShelterExpansionSystem.cs','SubterraneanSubsidenceEngine.cs']),
]
