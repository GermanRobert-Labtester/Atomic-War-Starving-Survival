# PLAN-AQUAPONICS-TRUTH-163 — Appendix A: Implementation Scaffold

**Generated:** 2026-09-21 by the session scaffold generator (paired variant, batch 3).
**Scaffolding authority:** [`PLAN-WATER-AGRICULTURE-46`](../EXPANSION_PROGRAM_WAVE5_2026-09-21/PLAN-WATER-AGRICULTURE-46.md) — adopt the authority's patterns rather than inventing a second architecture. **Convention authority:** `PLAN-ORPHAN-SEAL-01` (generated, reproducible appendices).
...
- Proposed method names: `SetupShelterAQScaffold` / `SaveShelterAQScaffold` (Plan 1 Appendix AI: collision-free)
- Loop/day coupling: consult Plan 1 Appendix AA before adding any step method.

## 5. Test scaffold (proposed, not created)

Proposed file: `Ashfall.Core.Tests/Shelter/AQ163ScaffoldTests.cs`

```csharp
// One fixture per package, plus one authority-conformance fixture.
public class AQ163ScaffoldTests
{
    [Fact] public void AQT163A_TODO() { /* loop-state model + owner table. */ }
    [Fact] public void AQT163B_TODO() { /* mass-balance test over a scripted month (inputs vs outputs within tolerance). */ }
    [Fact] public void AQT163C_TODO() { /* water coupling through Plan 46's owner (no private pool proof). */ }
    [Fact] public void AQT163D_TODO() { /* failure-mode table + one fixture per mode. */ }
    [Fact] public void AQT163E_TODO() { /* save round-trip + no re-roll on load. */ }
    [Fact] public void AQ163_AuthorityConformance_TODO() { /* pattern parity with PLAN-WATER-AGRICULTURE-46 */ }
}}
```
