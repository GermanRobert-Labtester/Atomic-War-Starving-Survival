# PLAN-ESPIONAGE-COUNTERINTEL-41 — Appendix A: Orphan Dossiers (espionage & counter-intelligence)
...
**Note:** requested-but-unreachable-listed systems not present: `FactionCovertOpsCoordinator` (they are either host-reachable already or type-level dead — see the Plan 1 appendices).
...
### 01. `InformantNetworkTradecraftEngine`
- **File:** `Espionage/InformantNetworkTradecraftEngine.cs` · **Types:** `InformantNetworkTradecraftEngine`
- **Known tests (1):** `Espionage/InformantNetworkTradecraftEngineTests.cs`
- **Candidate catalogs:** none by name match
- **Parent-plan mechanic:** Network
