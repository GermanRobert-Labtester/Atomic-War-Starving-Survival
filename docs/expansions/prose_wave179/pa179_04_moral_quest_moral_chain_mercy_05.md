# Subject Plan 179.04 — The Volunteer: branching-quest discovery prose
...
Review one field—`discovery`—for selector `quest_moral_chain_mercy_05` in `Assets/StreamingAssets/Data/moral_choice_quests_branching.json`. Current depth: 52 words / 273 characters. The aim is to clarify the authored encounter that players see when this moral-choice quest is offered. The plan does not ask for a longer passage; retain the current text if a revision would add no useful information.
...
This is the Mercy branch record **The Volunteer**. The branch identity and actual situation are source facts; do not use this pass to rewrite the larger quest arc.

## Verified premise and source evidence

- **VERIFIED (2026-09-24):** `quest_moral_chain_mercy_05` is present exactly once in the current `schema_version: 1` `quests` array, which contains 100 entries.
...
**Trigger:** A young woman asks to join your shelter specifically because she heard you help people.

**Place:** `loc_shelter_gate` · **category:** `comfort` · **day window:** 55–0 (0 max means unbounded in the current Core contract).

**Existing discovery prose (52 words / 273 characters):**

> She walked four days to reach your gate. 'I heard what you did,' she says. 'The family in the rain. The man who robbed you. The patrol you run for the small camps.' She has medical training — field surgery, triage. She wants to work. She wants to be somewhere that matters.

**Existing choices, frozen for context:** 1. Welcome her and assign her to the infirmary; 2. Welcome her with a probation period; 3. Ask what she expects in return; 4. Turn her away — the shelter can't support more people

Adjacent chain records: predecessor `quest_moral_chain_mercy_04`; successor `quest_moral_chain_mercy_06`. Read them in the live catalog before a revision; do not borrow a neighboring record’s reveal, character knowledge, or outcome.
...
```json
{
  ...
  "choices": [
    {
      "empathy_delta": 2,
      "epitaph": "Accepted the volunteer. She heard what I did and walked four days to help. The infirmary runs better now.",
      "label": "Welcome her and assign her to the infirmary",
      "moral_delta": 8,
      "outcome_text": "She unpacks her kit the same hour. Within a week the infirmary runs smoother than it has since the exchange. Your reputation brought her here. Her skill keeps people alive."
    },
    {
      "empathy_delta": 1,
      "epitaph": "Put her on probation. By day twelve she'd saved a hand. The probation was a formality after that.",
      "label": "Welcome her with a probation period",
      "moral_delta": 5,
      "outcome_text": "Thirty days. She agrees without argument. By day twelve she's saved a man's hand. By day twenty the probation feels like an insult you're both too polite to name."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Asked what she wanted. Food, shelter, purpose. Same as everyone. Clean deal.",
      "label": "Ask what she expects in return",
      "moral_delta": 2,
      "outcome_text": "'Food, shelter, purpose,' she says. 'Same as everyone.' It's honest. You let her in. The transaction is clean."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Turned away the medic. She walked four days back. Another camp gained what I refused.",
      "label": "Turn her away — the shelter can't support more people",
      "moral_delta": -4,
      "outcome_text": "She nods. She doesn't argue. She walks back the way she came, four days into nothing. A week later, a camp to the south advertises a new medic. Her."
    }
  ],
  "display_name": "The Volunteer",
  "id": "quest_moral_chain_mercy_05",
...
- Compare before/after JSON, proving only `quest_moral_chain_mercy_05.discovery` changed; assert all IDs, array order, gates, trigger/category/place, choice payloads, flags, outcomes, and score deltas are unchanged.
