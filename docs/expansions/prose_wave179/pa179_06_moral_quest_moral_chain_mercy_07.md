# Subject Plan 179.06 — The Betrayer's Child: branching-quest discovery prose
...
Review one field—`discovery`—for selector `quest_moral_chain_mercy_07` in `Assets/StreamingAssets/Data/moral_choice_quests_branching.json`. Current depth: 47 words / 243 characters. The aim is to clarify the authored encounter that players see when this moral-choice quest is offered. The plan does not ask for a longer passage; retain the current text if a revision would add no useful information.
...
This is the Mercy branch record **The Betrayer's Child**. The branch identity and actual situation are source facts; do not use this pass to rewrite the larger quest arc.

## Verified premise and source evidence

- **VERIFIED (2026-09-24):** `quest_moral_chain_mercy_07` is present exactly once in the current `schema_version: 1` `quests` array, which contains 100 entries.
...
**Trigger:** The child of someone who betrayed you arrives at your gate, alone and starving.

**Place:** `loc_shelter_gate` · **category:** `comfort` · **day window:** 75–0 (0 max means unbounded in the current Core contract).

**Existing discovery prose (47 words / 243 characters):**

> You know this face — she has her father's jaw, the man who sold your supply route to raiders three months ago. She's eight, alone, and hasn't eaten in days. Her father is dead. She doesn't know you know. She just knows the gate and the hunger.

**Existing choices, frozen for context:** 1. Take her in without hesitation; 2. Take her in but keep her identity quiet; 3. Feed her and send her to another camp; 4. Turn her away — her father's debt is not paid

Adjacent chain records: predecessor `quest_moral_chain_mercy_06`; successor `quest_moral_chain_mercy_08`. Read them in the live catalog before a revision; do not borrow a neighboring record’s reveal, character knowledge, or outcome.
...
```json
{
  ...
  "choices": [
    {
      "empathy_delta": 4,
      "epitaph": "Took in the betrayer's daughter. Didn't mention her father. She talks to the greenhouse plants now.",
      "label": "Take her in without hesitation",
      "moral_delta": 16,
      "outcome_text": "You don't mention her father. You give her food, a bed, a name on the roster. She's eight. She didn't choose her blood. By the second week, she's helping in the greenhouse, talking to the plants the way children do."
    },
    {
      "empathy_delta": 2,
      "epitaph": "Kept her identity quiet. She eats at the common table. Nobody asks about the jaw.",
      "label": "Take her in but keep her identity quiet",
      "moral_delta": 10,
      "outcome_text": "You tell no one whose daughter she is. She sleeps in the children's quarters. Eats at the common table. If anyone notices the jaw, they don't say."
    },
    {
      "empathy_delta": 1,
      "epitaph": "Fed the child and sent her south. Couldn't keep the betrayer's blood in my shelter. Couldn't starve it either.",
      "label": "Feed her and send her to another camp",
      "moral_delta": 4,
      "outcome_text": "You feed her, clean her up, and write a note to the camp south. They'll take a child. Everyone takes a child. You just can't take this particular one."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Turned away an eight-year-old for her father's crime. She walked east. I never asked where.",
      "label": "Turn her away — her father's debt is not paid",
      "moral_delta": -12,
      "outcome_text": "You tell her the shelter is full. She nods the way children nod when adults lie to them — accepting the shape without believing the content. She walks east. You never learn where she ends up."
    }
  ],
  "display_name": "The Betrayer's Child",
  "id": "quest_moral_chain_mercy_07",
...
- Compare before/after JSON, proving only `quest_moral_chain_mercy_07.discovery` changed; assert all IDs, array order, gates, trigger/category/place, choice payloads, flags, outcomes, and score deltas are unchanged.
