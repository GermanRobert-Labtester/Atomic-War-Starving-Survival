# Subject Plan 179.17 — The Listener: branching-quest discovery prose
...
This is the Iron branch record **The Listener**. The branch identity and actual situation are source facts; do not use this pass to rewrite the larger quest arc.

## Verified premise and source evidence

- **VERIFIED (2026-09-24):** `quest_moral_chain_iron_04` is present exactly once in the current `schema_version: 1` `quests` array, which contains 100 entries.
...
**Trigger:** A member of a rival settlement approaches you with information — and a price.

**Place:** `loc_eastern_road` · **category:** `trust` · **day window:** 8–0 (0 max means unbounded in the current Core contract).

**Existing discovery prose (87 words / 513 characters):**

> Her name is Sable. She sits across from you in the neutral ground between the two settlements, a burnt-out convenience store with no roof and one wall still standing. She says she can tell you when the Kessler group moves their supplies, where their watch schedule has gaps, which of their people are growing restless. She wants antibiotics for her sister. She wants them tomorrow. She says the information is worth more than medicine because information doesn't run out. You notice she hasn't blinked in a while.

**Existing choices, frozen for context:** 1. Pay her price. Full antibiotics course. Information is power.; 2. Counter-offer: partial payment, ongoing arrangement. Make her dependent.; 3. Refuse. Using her would make you no better than the people she's betraying.

Adjacent chain records: predecessor `quest_moral_chain_iron_03`; successor `quest_moral_chain_iron_05`. Read them in the live catalog before a revision; do not borrow a neighboring record’s reveal, character knowledge, or outcome.
...
```json
{
  ...
  "choices": [
    {
      "empathy_delta": 0,
      "epitaph": "I bought a spy with medicine. Her sister lived. Kessler didn't notice the holes until they were too big to patch.",
      "label": "Pay her price. Full antibiotics course. Information is power.",
      "moral_delta": -7,
      "outcome_text": "You hand over the pills — half your remaining stock. Sable counts them before she pockets them. Over the next week, she delivers: supply movements, guard rotations, three names of people in Kessler's group who might flip. The intelligence is good. You restructure your own patrols around it. Kessler loses two trade caravans to 'bad luck' on the eastern road. He doesn't know you know his schedule. Sable's sister improves. Sable keeps talking."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Three pills at a time. Enough to keep hope alive, not enough to close the deal. She hates me. She needs me. That's the same thing now.",
      "label": "Counter-offer: partial payment, ongoing arrangement. Make her dependent.",
      "moral_delta": -10,
      "outcome_text": "You give her three pills — enough for two days. Tell her the rest comes with each delivery. Sable's eyes go flat. She understands the arrangement. Over the following weeks, she brings you intelligence regularly. Her sister's condition stabilizes but doesn't improve. Sable starts bringing you information about her own group's internal disputes — things she wasn't asked for, things that suggest she's trying to prove her value. You've created a dependency and then exploited it. She knows this. You both know this."
    },
    {
      "empathy_delta": 1,
      "epitaph": "I gave her a name instead of taking hers. The water station contact came through. I don't know what Sable did with the medicine. I hope her sister is breathing.",
      "label": "Refuse. Using her would make you no better than the people she's betraying.",
      "moral_delta": 8,
      "outcome_text": "You stand up. Tell her you don't trade in people's secrets for their sister's life. Sable stares at you. Then she laughs — one short bark that echoes off the remaining wall. She says nobody's offered to help without a price in four months. You don't have antibiotics to spare, but you have a contact at the water station who trades in medical supplies. You write down a name and a location. Sable looks at the paper like it might bite her. She walks out. You never learn what she knew about Kessler. You sleep well."
    }
  ],
  "display_name": "The Listener",
  "id": "quest_moral_chain_iron_04",
...
- Compare before/after JSON, proving only `quest_moral_chain_iron_04.discovery` changed; assert all IDs, array order, gates, trigger/category/place, choice payloads, flags, outcomes, and score deltas are unchanged.
