# Subject Plan 179.14 — The Weight of Filters: branching-quest discovery prose
...
Review one field—`discovery`—for selector `quest_moral_chain_iron_01` in `Assets/StreamingAssets/Data/moral_choice_quests_branching.json`. Current depth: 54 words / 307 characters. The aim is to clarify the authored encounter that players see when this moral-choice quest is offered. The plan does not ask for a longer passage; retain the current text if a revision would add no useful information.

**Editorial question:** Keep the evidence, resource calculation, and authority pressure concrete. Do not make severity synonymous with competence or turn a hard policy into a promised result. Where a choice concerns disclosure, do not reveal a fact earlier than the current discovery text permits.

This is the Iron branch record **The Weight of Filters**. The branch identity and actual situation are source facts; do not use this pass to rewrite the larger quest arc.

## Verified premise and source evidence

- **VERIFIED (2026-09-24):** `quest_moral_chain_iron_01` is present exactly once in the current `schema_version: 1` `quests` array, which contains 100 entries.
...
**Trigger:** You discover an elderly survivor has been hoarding water filters while the shelter's common supply runs dry.

**Place:** `loc_shelter_gate` · **category:** `trust` · **day window:** 1–0 (0 max means unbounded in the current Core contract).

**Existing discovery prose (54 words / 307 characters):**

> Maren's hands shake when she unlocks the cellar door. Behind the canned peaches and moth-eaten blankets, you count eleven ceramic filters — enough for a family for a year. She watches you count them. Her grandson coughs in the next room, a wet sound that doesn't stop. She says nothing. She doesn't have to.

**Existing choices, frozen for context:** 1. Take the filters. Tell her you'll distribute them fairly through the shelter.; 2. Offer to trade — your labor for a fair split. Keep her dignity intact.; 3. Report her to the shelter council. Let them decide what's 'fair.'; 4. Say nothing. Her resources are her business.

Adjacent chain records: predecessor `none (chain opening)`; successor `quest_moral_chain_iron_02`. Read them in the live catalog before a revision; do not borrow a neighboring record’s reveal, character knowledge, or outcome.
...
```json
{
  ...
  "choices": [
    {
      "empathy_delta": 0,
      "epitaph": "I told myself it was for the many. The math was clean. The boy wasn't.",
      "label": "Take the filters. Tell her you'll distribute them fairly through the shelter.",
      "moral_delta": -12,
      "outcome_text": "You carry them out in your pack. Maren doesn't argue. That night, you hand out filters to twelve families — including your own. The shelter council thanks you. Maren's grandson drinks unfiltered water. He stops coughing three days later. Not because he's better."
    },
    {
      "empathy_delta": 1,
      "epitaph": "Three filters. Two days of work. One old woman who still looked me in the eye.",
      "label": "Offer to trade — your labor for a fair split. Keep her dignity intact.",
      "moral_delta": 4,
      "outcome_text": "You spend two days fixing her roof in exchange for three filters. She wraps them in cloth and hands them to you herself. The shelter gets three more filters than it had yesterday. Maren's grandson drinks clean water. You drink clean water. Nobody owes anyone anything. It feels like a luxury."
    },
    {
      "empathy_delta": 0,
      "epitaph": "I let seven people decide for one. Easier than deciding myself, I told myself.",
      "label": "Report her to the shelter council. Let them decide what's 'fair.'",
      "moral_delta": -6,
      "outcome_text": "The council votes. Seven filters confiscated, four left to Maren. She complies quietly. Her grandson gets two of the four. You watch the vote from the back of the room and notice nobody looked at you while it happened. The council chair shakes your hand afterward. Her grip is damp."
    },
    {
      "empathy_delta": 2,
      "epitaph": "I walked past eleven filters and a dying child. I still sleep. Mostly.",
      "label": "Say nothing. Her resources are her business.",
      "moral_delta": 6,
      "outcome_text": "You close the cellar door. Maren watches you walk away and something in her shoulders drops — not relief exactly, but the absence of a different kind of tension. The shelter's water problem continues. You drink your ration and taste the rust. Other people's grandchildren drink the same."
    }
  ],
  "display_name": "The Weight of Filters",
  "id": "quest_moral_chain_iron_01",
...
- Compare before/after JSON, proving only `quest_moral_chain_iron_01.discovery` changed; assert all IDs, array order, gates, trigger/category/place, choice payloads, flags, outcomes, and score deltas are unchanged.
