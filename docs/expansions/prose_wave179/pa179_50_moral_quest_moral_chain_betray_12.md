# Subject Plan 179.50 — The Ghost at the Gate: branching-quest discovery prose
...
Review one field—`discovery`—for selector `quest_moral_chain_betray_12` in `Assets/StreamingAssets/Data/moral_choice_quests_branching.json`. Current depth: 74 words / 396 characters. The aim is to clarify the authored encounter that players see when this moral-choice quest is offered. The plan does not ask for a longer passage; retain the current text if a revision would add no useful information.
...
This is the Betray branch record **The Ghost at the Gate**. The branch identity and actual situation are source facts; do not use this pass to rewrite the larger quest arc.

## Verified premise and source evidence

- **VERIFIED (2026-09-24):** `quest_moral_chain_betray_12` is present exactly once in the current `schema_version: 1` `quests` array, which contains 100 entries.
...
**Trigger:** Someone you betrayed long ago returns — scarred, hungry, and asking for help. They don't recognize you at first.

**Place:** `loc_shelter_gate` · **category:** `trust` · **day window:** 100–0 (0 max means unbounded in the current Core contract).

**Existing discovery prose (74 words / 396 characters):**

> The stranger at the gate has a burn scar across the left side of their face. They ask for water and a night's rest. You recognize them — Corin. Six months ago, you sold their location to the raiders to buy safe passage for your group. You told yourself it was strategic. Corin survived the raid, barely. They don't recognize you. Not yet. The scar changed their face. But their eyes are the same.

**Existing choices, frozen for context:** 1. Reveal yourself and accept whatever comes; 2. Give them shelter but never reveal who you are; 3. Turn them away before they recognize you; 4. Recruit them — they're useful, history aside

Adjacent chain records: predecessor `quest_moral_chain_betray_11`; successor `quest_moral_chain_betray_13`. Read them in the live catalog before a revision; do not borrow a neighboring record’s reveal, character knowledge, or outcome.
...
```json
{
  ...
  "choices": [
    {
      "empathy_delta": 3,
      "epitaph": "Said their name. Told them everything. They walked out. Didn't come back with raiders.",
      "label": "Reveal yourself and accept whatever comes",
      "moral_delta": 10,
      "outcome_text": "You say their name. Corin freezes. The water cup stops halfway to their mouth. You tell them the truth — all of it. The silence afterward is the longest of your life. Corin sets the cup down, stands, and walks out the gate. They don't look back. But they don't come back with raiders either. Some debts are paid in restraint."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Gave the stranger water and a corner. They thanked me. I never said the name.",
      "label": "Give them shelter but never reveal who you are",
      "moral_delta": -4,
      "outcome_text": "You give the stranger water, a corner to sleep in, a ration. They thank you with the easy gratitude of someone who expects nothing. You watch them eat and wonder if this is mercy or the longest con you've ever played. They leave at dawn. You never say the name."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Turned them away. The scar caught the light. They didn't turn around. I checked the gate twice.",
      "label": "Turn them away before they recognize you",
      "moral_delta": -8,
      "outcome_text": "You tell them the shelter is full. It isn't. You watch them walk down the road, the scar catching the light. If they turn around, if they remember, if they talk — you'll have to deal with it. But they don't turn around. The road swallows them. You lock the gate and check it twice."
    },
    {
      "empathy_delta": 0,
      "epitaph": "Hired them. They're strong, reliable. They never suspect. The most efficient kind of betrayal.",
      "label": "Recruit them — they're useful, history aside",
      "moral_delta": -10,
      "outcome_text": "You offer Corin a place. Steady work, a bunk, food. They accept. Over the following weeks, they prove competent — strong, reliable, good with their hands. You never mention the past. They never suspect. It's the most efficient betrayal: making the betrayed work for the betrayer and calling it opportunity."
    }
  ],
  "display_name": "The Ghost at the Gate",
  "id": "quest_moral_chain_betray_12",
...
- Compare before/after JSON, proving only `quest_moral_chain_betray_12.discovery` changed; assert all IDs, array order, gates, trigger/category/place, choice payloads, flags, outcomes, and score deltas are unchanged.
