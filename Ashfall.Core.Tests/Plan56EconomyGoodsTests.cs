...
namespace Ashfall.Core.Tests
{
    ...
    public sealed class Plan56EconomyGoodsTests
    {
        ...
        [Fact]
        public void Catalog_reaches_the_51_good_breadth_target()
        {
            // Plan 56 follow-up: 40 baseline + 8 category-fill goods + 2
            // trade-parity goods + the current crop-roster oilseed good.
            var (_, goods) = Load();
            Assert.Equal(51, goods.Count);
        }
