...
namespace Ashfall.Core.Tests
{
    ...
    internal static class IntegrityScratchFixture
    {
        ...
        private const string DutyRoles =
            ...
            "    {\"id\":\"ward\",\"skill_id\":\"\",\"minimum_skill\":0.0,\"maximum_fatigue\":85.0,\"minimum_health\":35.0,\"maximum_dose_msv\":150.0,\"maximum_hours\":12.0,\"maximum_hours_if_impaired\":6.0,\"allow_unfit\":false,\"light_duty\":false,\"requires_not_quarantined\":true,\"precision_work\":true,\"hazard_class\":\"medical\"}\n" +
            "  ]\n" +
            "}";
