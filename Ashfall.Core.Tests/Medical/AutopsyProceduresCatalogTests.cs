...
namespace Ashfall.Core.Tests.Medical
{
    public sealed class AutopsyProceduresCatalogTests
    {
        ...
        public void Runtime_AutopsySystemQueueAndBeginConsumesSupplies()
        {
            ...
            // Provide supplies for procedure_deprivation_pathology (medical_scissors, protective_rubber_gloves, field_surgical_kit, clean_water, sterilised_bandage)
            inv.AddById("medical_scissors", 1);
            inv.AddById("protective_rubber_gloves", 1);
            inv.AddById("field_surgical_kit", 1);
            inv.AddById("clean_water", 1);
            inv.AddById("sterilised_bandage", 1);
            ...
            Assert.Equal(0, inv.CountById("sterilised_bandage"));
        ...
        public void Runtime_SaveLoadPreservesCompletedSpecimensAndCases()
        {
            ...
            inv.AddById("protective_rubber_gloves", 2);
            inv.AddById("field_surgical_kit", 2);
            inv.AddById("clean_water", 2);
            inv.AddById("sterilised_bandage", 2);
