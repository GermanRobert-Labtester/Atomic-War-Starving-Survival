...
namespace Ashfall.Core.Tests
{
    public class VersionReportContractTests
    {
        ...
        public void AllPersistenceFormats_DistinguishesVersionedCodecsAndChecksumEnvelopes()
        {
            ...
            // 160 unversioned checksum envelopes, including the Plans 130–133
            ...
            Assert.Equal(160, envelopes.Count);
        ...
        public void FormatPersistenceInventory_RendersSummaryAndEntries()
        {
            ...
            Assert.Contains("Save Persistence Inventory (166 sections: 6 versioned codecs, 160 checksum envelopes):", inventory);
