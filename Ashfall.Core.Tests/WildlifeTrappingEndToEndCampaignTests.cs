...
{
    /// <summary>
    /// Flagship Track 8: End-to-End Campaign Smoke Test.
    ///
    ...
    /// </summary>
    public sealed class WildlifeTrappingEndToEndCampaignTests
    {
        ...
        public void Day1_DeployTrap_ConsumesTrapItemAndInitializesDurabilityThree()
        {
            ...
            var sys = new WildlifeTrappingSystem(new Ashfall.Core.SeededRng(42));
            LoadCatalog().RegisterWith(sys);
        ...
        public void Day2_CampaignSave_CapturesConsistentMultiSystemState()
        {
            ...
            Assert.Equal("site_snare_1", state.trapSites[0].siteId);
            Assert.Equal("trap_improvised_wire", state.trapSites[0].trapId);

            var serializer = new SystemTextJsonSerializer();
            string json = serializer.Serialize(state);
            Assert.Contains("\"site_snare_1\"", json);
            Assert.Contains("\"trap_improvised_wire\"", json);
            Assert.Contains("\"systemId\"", json);
        }

        [Fact]
        public void Day2_CampaignRestore_RestoresEquivalentOperationalState()
        {
            var sysA = new WildlifeTrappingSystem(new Ashfall.Core.SeededRng(42));
            var cat = LoadCatalog();
            ...
            var sysB = new WildlifeTrappingSystem(new Ashfall.Core.SeededRng(999));
        ...
        public void Day3_PostRestoreContinuation_MatchesUninterruptedTrace()
        {
            ...
            var rngA = new Ashfall.Core.SeededRng(42);
            ...
            var rngB = new Ashfall.Core.SeededRng(42);
        ...
        public void CampaignSmoke_Seed42_ThreeCompleteRuns_YieldIdenticalEventTracesAndHashes()
        {
            ...
            (List<string> trace, string finalHash) RunLifecycle(int seed)
            {
                ...
                var sys = new WildlifeTrappingSystem(new Ashfall.Core.SeededRng(seed));
                ...
                var restoredSys = new WildlifeTrappingSystem(new Ashfall.Core.SeededRng(99999));
