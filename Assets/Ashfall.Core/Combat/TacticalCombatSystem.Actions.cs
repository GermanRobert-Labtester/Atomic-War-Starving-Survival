    ...
    public partial class TacticalCombatSystem
    {
        ...
        public CombatActionResult PlayerFire(string targetId, ISeededRng rng, string? subjectId = null, float motionAccuracyScale = 1f)
        {
            ...
            var ctx = new BallisticContext
            {
                ...
                WeaponRangeMod = def.range * (weapon.BallisticsRangeMultiplier <= 0f ? 1f : weapon.BallisticsRangeMultiplier),
                ...
                ExtraCritChance = Math.Clamp(
                    ((weapon.BallisticsCriticalMultiplier <= 0f ? 1f : weapon.BallisticsCriticalMultiplier) - 1f) * 0.05f,
                    0f, 0.10f),
