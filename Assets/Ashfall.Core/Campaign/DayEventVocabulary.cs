...
namespace Ashfall.Core.Campaign
{
    ...
    public static class DayEventVocabulary
    {
        ...
        private static readonly Dictionary<string, SemanticKind> SemanticKindMap = new(StringComparer.Ordinal)
        {
            ...
            { "antenatal_maternal_health_ticked", SemanticKind.Heartbeat },
            ...
            { "dependency_taper_ticked", SemanticKind.Heartbeat },
            ...
            { "wildlife_harvest_ticked", SemanticKind.Heartbeat },
            { "storm_forecast_ticked", SemanticKind.Heartbeat },
            { "broadsheet_press_ticked", SemanticKind.Heartbeat },
            { "kilnworks_ticked", SemanticKind.Heartbeat },
            ...
            { "mechanical_driveline_ticked", SemanticKind.Heartbeat },
            ...
            { "shelter_maintenance_ticked", SemanticKind.Heartbeat },
            { "shelter_archive_ticked", SemanticKind.Heartbeat },
            { "sleep_acoustic_rest_ticked", SemanticKind.Heartbeat },
            { "subterranean_ticked", SemanticKind.Heartbeat },
            { "survivor_dreams_ticked", SemanticKind.Heartbeat },
            { "survivor_routines_ticked", SemanticKind.Heartbeat },
            ...
            { "mutation_developed", SemanticKind.Survivor },
