...
namespace Ashfall.Core.Content
{
    ...
    public sealed class ContentUtilizationScanner
    {
        ...
        private static readonly HashSet<string> AuthoritativeCatalogs = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "spiritual_rituals.json", "memorial_rites.json", "belief_movements.json",
        ...
        private void InventoryLoaders()
        {
            ...
            var loaderPatterns = new Dictionary<string, string[]>
            {
                ...
                ["regional_treaties.json"] = new[] { "RegionalTreatyCatalogLoader", "RegionalTreatySystem" },
                ...
                ["hydroponic_crops.json"] = new[] { "HydroponicCropCatalogLoader", "HydroponicBiomeSystem" },
                ["spiritual_rituals.json"] = new[] { "SpiritualCatalogLoader", "SpiritualMeaningCoordinator" },
                ["memorial_rites.json"] = new[] { "SpiritualCatalogLoader", "SpiritualMeaningCoordinator" },
                ["belief_movements.json"] = new[] { "SpiritualCatalogLoader", "SpiritualMeaningCoordinator" },
        ...
        private void InventoryRegistries()
        {
            ...
            var registryMap = new Dictionary<string, string>
            {
                ...
                ["hydroponic_crops.json"] = "HydroponicCropCatalog",
                ["spiritual_rituals.json"] = "SpiritualCatalogLoader",
                ["memorial_rites.json"] = "SpiritualCatalogLoader",
                ["belief_movements.json"] = "SpiritualCatalogLoader",
                ["agriculture_items.json"] = "ItemCatalogLoader",
                ...
                ["regional_treaties.json"] = "RegionalTreatySystem",
        ...
        private void InventoryRuntimeSystems()
        {
            ...
            var consumerMap = new Dictionary<string, string[]>
            {
                ...
                ["regional_treaties.json"] = new[] { "RegionalTreatySystem" },
                ...
                ["hydroponic_crops.json"] = new[] { "HydroponicBiomeSystem" },
                ["spiritual_rituals.json"] = new[] { "SpiritualMeaningCoordinator" },
                ["memorial_rites.json"] = new[] { "SpiritualMeaningCoordinator" },
                ["belief_movements.json"] = new[] { "SpiritualMeaningCoordinator" },
        ...
        private void InventoryUiSurfaces()
        {
            var uiConsumers = new Dictionary<string, string[]>
            {
                ...
                ["hydroponic_crops.json"] = new[] { "ExpansionsHubPanel" },
                ["spiritual_rituals.json"] = new[] { "IronCenotaphMemorialPanel" },
                ["memorial_rites.json"] = new[] { "IronCenotaphMemorialPanel" },
                ["belief_movements.json"] = new[] { "IronCenotaphMemorialPanel" },
                ...
                ["regional_treaties.json"] = new[] { "RegionalTreatyPanel" },
        ...
        private void InventoryTests()
        {
            var testCoveredCatalogs = new HashSet<string>
            {
                ...
                "power_grid.json", "greenhouse_items.json", "hydroponic_crops.json",
