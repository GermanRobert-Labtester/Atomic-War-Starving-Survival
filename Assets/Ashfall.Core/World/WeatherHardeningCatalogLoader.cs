...
{
    public static class WeatherHardeningCatalogLoader
    {
        public const string CatalogFileName = "weather_hardening_upgrades.json";

        public static WeatherHardeningCatalog? Load(string dataDir, IFileIO fileIO, IJsonSerializer serializer)
        {
            ...
            try
            {
                ...
                return serializer.Deserialize<WeatherHardeningCatalog>(json);
            }
            catch (Exception ex)
            {
