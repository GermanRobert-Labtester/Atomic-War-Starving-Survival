...
namespace AtomicWar._Game.Core
{
    ...
    /// Two-way flags consumed by Exp 2/3: holdfast_levy_honour / _substitute / _refuse.
    /// </summary>
    [Serializable]
    ...
    {
        public string[] survivorIds = new string[0];
    ...
    public class CensusClaimSystem
    {
        ...
        /// <summary>Send three *other* people. Named cap still three.</summary>
        ...
        {
            _state.officeTrust = Mathf.Clamp(_state.officeTrust + delta, -100f, 100f);
            RaiseChanged();
        }
