...
namespace AtomicWar._Game.Core
{
    public partial class GameBootstrap
    {
            ...
            new Dictionary<string, string[]>
        {
            ...
            // Lore bible 05_FACTIONS — Current NPC state classes (acronym prefix
            // breaks ToSnakeCase, so these need explicit aliases).
            { "NPCArchivists",           new[] { "npc_archivists" } },
            { "NPCSunSeekers",           new[] { "npc_sun_seekers" } },
            { "NPCOsteophages",          new[] { "npc_osteophages" } },
            { "NPCLamplighters",         new[] { "npc_lamplighters" } },
            { "NPCQuietHouse",           new[] { "npc_quiet_house" } },
            { "NPCGrainExchange",        new[] { "npc_grain_exchange" } },
            { "NPCTally",                new[] { "npc_tally" } },
            { "NPCUndertow",             new[] { "npc_undertow" } },
            { "HoldfastQuests",          new[] { "holdfast_quest_system" } },
            { "NPCEdorVale",             new[] { "npc_edor_vale" } },
            { "NPCYaraHolm",             new[] { "npc_yara_holm" } },
            { "NPCTheOffice",            new[] { "npc_the_office" } },
            ...
            { "AshTideScheduler", new[] { "ash_tide" } },
            { "BurnWardSystem", new[] { "burn_ward_system" } },
            { "ElectromagneticDecay", new[] { "electromagnetic_decay_daily" } },
            { "GenerationalPsychologySystem", new[] { "expansion4_daily" } },
            { "LetheProtocolSystem", new[] { "lethe_protocol" } },
            { "OzoneScourgeSystem", new[] { "ozone_scourge" } },
            { "StructuralEntropySystem", new[] { "expansion4_daily" } },
            { "UXOField", new[] { "uxo_field" } },
