...
{
    public static class DutyRosterLocationsCatalogLoader
    {
        [Serializable]
        private class Container
        {
            public DutyRosterLocationEntry[] entries;
        }

        private static List<DutyRosterLocationEntry> _cache;

        public static List<DutyRosterLocationEntry> Load()
        {
            if (_cache != null) return _cache;
            _cache = new List<DutyRosterLocationEntry>();
            string path = Path.Combine(Application.streamingAssetsPath, "Data/duty_roster_locations.json");
        ...
        public static DutyRosterLocationEntry GetById(string id)
        {
        ...
        public static LocationDefinitionSO Materialise(DutyRosterLocationEntry e)
        {
        ...
        public static string ComposeDescription(DutyRosterLocationEntry e)
        {
            if (e == null) return "";
