        ...
        private static void BuildLootPools()
        {
            ...
            Pools[WorldLootFaction.Rebel] = Concat(
                ...
                new[]
                {
                    ...
                    new WorldLootEntry("rifle_ak47_762x39", 0.35f),
                    new WorldLootEntry("rifle_ak74u_545x39", 0.35f),
                    new WorldLootEntry("lmg_rpk74_545x39", 0.20f),
                    new WorldLootEntry("shotgun_browning_auto5_16ga", 0.30f),
                    new WorldLootEntry("sniper_mosin_nagant_m9031_762x54r", 0.25f)
                });
            ...
            Pools[WorldLootFaction.Military] = Concat(
                ...
                new[]
                {
                    ...
                    new WorldLootEntry("rifle_m4a1_carbine_556x45", 0.35f),
                    new WorldLootEntry("rifle_hk416_556x45", 0.30f),
                    new WorldLootEntry("rifle_steyr_aug_a3_556x45", 0.25f),
                    new WorldLootEntry("rifle_fn_fal_762x51", 0.30f),
                    new WorldLootEntry("rifle_hk_g3_762x51", 0.30f),
                    new WorldLootEntry("shotgun_benelli_m4_super90_12ga", 0.25f),
                    new WorldLootEntry("sniper_svd_dragunov_762x54r", 0.20f)
                });
            ...
            Pools[WorldLootFaction.SpecOpsRebel] = Concat(
                ...
                new[]
                {
                    ...
                    new WorldLootEntry("rifle_fn_scar_l_556x45", 0.35f),
                    new WorldLootEntry("rifle_q_honey_badger_300blk", 0.30f),
                    new WorldLootEntry("pdw_fn_p90_57x28", 0.30f),
                    new WorldLootEntry("pdw_hk_mp7a2_46x30", 0.30f),
                    new WorldLootEntry("sniper_steyr_ssg08_338lapua", 0.20f)
                });
            ...
            Pools[WorldLootFaction.BlackOpsMilitary] = Concat(
                ...
                new[]
                {
                    ...
                    new WorldLootEntry("rifle_sig_mcx_rattler_300blk", 0.35f),
                    new WorldLootEntry("rifle_ddm4_pdw_300blk", 0.30f),
                    new WorldLootEntry("pdw_cmmg_four6_46x30", 0.30f),
                    new WorldLootEntry("sniper_cheytac_m200_intervention_408cheytac", 0.15f),
                    new WorldLootEntry("sniper_barrett_m82a1_50bmg", 0.10f)
                });
        }
