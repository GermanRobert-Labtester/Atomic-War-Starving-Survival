...
namespace AtomicWar._Game.Inventory
{
    ...
    public partial class Item_AmmoTypes
    {
        ...
        private static void BuildCatalog()
        {
            Catalog.Clear();
            LegacyAliases.Clear();
            // Keep the four loot-list caches in CombatLoot consistent with
            // the rebuild. The caches live in a different partial and would
            // otherwise point at a stale catalog.
            ResetCatalogCache();
