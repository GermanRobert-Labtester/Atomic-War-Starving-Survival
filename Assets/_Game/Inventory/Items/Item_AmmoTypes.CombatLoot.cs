...
namespace AtomicWar._Game.Inventory
{
    ...
    public partial class Item_AmmoTypes
    {
        ...
        /// <summary>
        /// Drop the four loot-list caches. BuildCatalog clears Catalog and
        /// LegacyAliases but cannot reach into CombatLoot (different partial),
        /// so it calls this to keep the static state consistent if a rebuild
        /// is ever triggered mid-PlayMode. No-op today; cheap insurance.
        /// </summary>
        internal static void ResetCatalogCache()
        {
            _civilianLootCache = null;
            _militaryExclusiveCache = null;
            _battleRifleCache = null;
            _apApiCache = null;
        }
