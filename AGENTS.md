# PROJECT: ASHFALL — Godot 2D Survival Management Game

This is the active, compact instruction authority for humans and AI agents.
The complete pre-foreman rulebooks are preserved byte-for-byte in
`docs/archive/agent-rules/2026-09-12-pre-foreman/`; they are historical
