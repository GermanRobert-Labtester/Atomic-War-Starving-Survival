...
sc.render.filepath="artifacts/shelter-bake/debug_light2.png"
bpy.ops.render.render(write_still=True)
print("debug2 done; cycles max_bounces:", sc.cycles.max_bounces,
      "diffuse:", sc.cycles.diffuse_bounces,
      "clamp:", sc.cycles.clamp_indirect,
      "light max_bounces:", ld.cycles.max_bounces if hasattr(ld,'cycles') else 'n/a')
